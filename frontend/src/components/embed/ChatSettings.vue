...
const handleSetBashBanner = (visible: boolean) => {
    ...
    showToast(
      visible ? "Bash 运行环境提醒已开启" : "Bash 运行环境提醒已关闭",
          ...
          <div class="bg-gray-50/50 dark:bg-gray-900/20 border border-gray-100 dark:border-gray-700/40 rounded-xl p-3.5 space-y-4">
            ...
            <div class="flex items-start justify-between py-1">
              <div class="flex items-start space-x-2.5 pr-2">
                ...
                <div>
                  <h5 class="text-xs font-black text-gray-700 dark:text-gray-200">Bash 运行环境提醒</h5>
                  <p class="text-[9.5px] text-gray-400 dark:text-gray-500 leading-normal mt-0.5">Bash 开始执行时在页面顶部短暂弹出，不固定在输入框上方</p>
                </div>
              </div>
